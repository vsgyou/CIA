...
from utils import data_load, calculus_pop, calculus_user_pop, load_movie_data, user_movie_name
...
def setup_models(model_choice, sampling_choice, num_user=943, num_item=1682):
    if model_choice == "MF":
        standard_load_path = "model_pth/Movielens_MF_saved_model.pth"
        if sampling_choice == "Counterfactual":
            compare_load_path = "model_pth/Movielens_MF_cf_saved_model.pth"
        elif sampling_choice == "Popularity":
            compare_load_path = "model_pth/Movielens_MF_pop_saved_model.pth"
        standard_model = MF(num_user, num_item, embedding_k = 4)
        compare_model = MF(num_user, num_item, embedding_k = 4)
        
    elif model_choice == "NCF":
        standard_load_path = "model_pth/Movielens_NCF_saved_model.pth"
        if sampling_choice == "Counterfactual":
            compare_load_path = "model_pth/Movielens_NCF_cf_saved_model.pth"
        elif sampling_choice == "Popularity":
            compare_load_path = "model_pth/Movielens_NCF_pop_saved_model.pth"
